...
const Page = () => {
  return (
    <div className="flex flex-col xl:flex-row">
      <section className="px-6 sm:px-10 xl:px-11 pt-6 sm:pt-16 xl:pt-9 pb-11 sm:pb-24 bg-fadedBlue text-darkGreen xl:order-2">
        ...
        <div className="pt-9 pb-20 xl:pt-16 flex flex-col xl:flex-row sm:grid sm:grid-cols-[305px_305px] xl:flex sm:justify-center sm:items-start xl:gap-4 sm:justify-items-center gap-7 sm:gap-x-5 sm:gap-y-20 items-center">
